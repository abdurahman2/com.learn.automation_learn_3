...
public class DisplayOfTheTaskTest {
    ...
    List<Book> listOfRandomBooks = List.of(new Book("Zzq", 23), new Book("Privet", 26),
    ...
    public void listOfRandomBooks() {
        ...
        Assertions.assertEquals(10, listOfRandomBooks.size(),
    ...
    public void countOfBookNamesWith5Character() {
        int countOfBookNamesWith5Character = Book.totalOfBookNamesWith5Character(listOfRandomBooks);
